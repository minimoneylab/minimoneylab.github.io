...
ART_STYLES = [
    ...
    (
        ...
        "bold geometric wisteria and checked patterns covering clothing and backgrounds, "
        "dramatic action poses with sword trails and elemental breath technique effects, "
        "Total Concentration Breathing as swirling elemental energy — fire, water, thunder, wind, "
        "highly expressive large eyes with detailed iris reflections, "
        "washi paper texture visible beneath ink lines, "
        "rich jewel-tone palette: crimson, deep indigo, gold, forest green"
    ),
    (
        "Masashi Kishimoto Naruto manga art style: "
        "extreme dynamic action pose with chakra energy exploding outward, "
        "speed lines radiating from central figure creating explosive kinetic energy, "
        "Rasengan or Chidori rendered as swirling blue-white electrical plasma, "
        "bold thick black outlines, dramatic foreshortening — fist rushing toward viewer, "
        "orange and blue color palette with electric white energy highlights"
    ),
    (
        "Akira Toriyama Dragon Ball manga art style: "
        "clean confident ink lines with precise weight variation, "
        "Super Saiyan transformation with electric golden aura crackling around the figure, "
        "extreme power-up pose: legs planted wide, muscles bulging, screaming skyward, "
        "energy ki aura as bold radiating light beams and crackling electricity, "
    ...
    (
        ...
        "cursed energy domain expansion — black void background with ritual pattern emerging, "
        ...
        "Gojo Satoru six eyes with snowflake star iris pattern, "
    ...
    (
        ...
        "massive titan figure looming against the sky — grotesque proportions, uncanny smile, empty eyes, "
        ...
        "gritty despair and existential dread, rough cross-hatching, heavy black shadows"
    ),
    (
    ...
    (
        ...
        "clean pen and ink outlines with flat watercolour fills — no gradients, "
        "creature design combining natural animals into one new being, "
        "simple bold silhouette readable at tiny size, "
        "limited palette — three to four colors maximum per creature, "
        "the natural history field guide applied to fantasy creatures"
    ),
    (
        "Nintendo Super Mario Bros. official art style: "
        "bold cel-shaded 3D render with clean outlines, "
        "primary color palette: pure red, blue, yellow — saturated and joyful, "
        "Mario in red cap and overalls mid-jump fist raised, "
        "gold coins scattered, question mark blocks floating, green pipes, "
        "Mushroom Kingdom — rolling green hills, blue sky, white puffy clouds"
    ),
    (
...
def generate_daily_story(core_data, dynamic_data, news_items, art_style):
    try:
        prompt = (
            ...
            "4. Create a vivid creative image — symbolic Japanese cultural imagery, NOT a chart. "
            "Full commitment to the specified art style.\n"
...
def generate_weekly_story(core_data, dynamic_data, news_items, art_style):
    try:
        ...
        prompt = (
            ...
            "4. Create a vivid weekly image — Japanese magazine cover style, full art style commitment.\n"
